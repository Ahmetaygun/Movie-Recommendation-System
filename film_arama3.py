...
import random
# rastgele izlenmiş filmler oluşturuyoruz
...
# Rastgele 5 izlenmiş filmi seç
random_watched_movies = df.sample(5, random_state=42)  # Rastgelelik için random_state eklenmiştir

# İzlenmiş ve izlenmemiş filmleri ayır
watched_movies = random_watched_movies
unwatched_movies = df[~df['title'].isin(watched_movies['title'])]
